...
public class EmozioniCanzone implements Serializable {
    ...
    public void setNostalgia(int nostalgia) {
        this.nostalgia = nostalgia;
    }
    ...
    public void setTenderness(int tenderness) {
        this.tenderness = tenderness;
    }
    ...
    public void setSolemnity(int solemnity) {
        this.solemnity = solemnity;
    }
    ...
    public void setAmazement_notes(String amazement_notes) {
        this.amazement_notes = amazement_notes;
    }
    ...
    public void setNostalgia_notes(String nostalgia_notes) {
        this.nostalgia_notes = nostalgia_notes;
    }
    ...
    public void setCalmness_notes(String calmness_notes) {
        this.calmness_notes = calmness_notes;
    }
    ...
    public void setPower_notes(String power_notes) {
        this.power_notes = power_notes;
    }
    ...
    public void setJoy_notes(String joy_notes) {
        this.joy_notes = joy_notes;
    }
    ...
    public void setTension_notes(String tension_notes) {
        this.tension_notes = tension_notes;
    }
    ...
    public void setSadness_notes(String sadness_notes) {
        this.sadness_notes = sadness_notes;
    }
    ...
    public void setTenderness_notes(String tenderness_notes) {
        this.tenderness_notes = tenderness_notes;
    }
    ...
    public void setSolemnity_notes(String solemnity_notes) {
        this.solemnity_notes = solemnity_notes;
    }
