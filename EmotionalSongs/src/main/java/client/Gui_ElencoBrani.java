...
public class Gui_ElencoBrani extends javax.swing.JPanel {
     ...
     *
     * @param userId parametro di tipo String contenente l'id dell'utente
     ...
     * @param is parametro di tipo InterfacciaServizio, contenente i metodi messi a disposizione dal server
     */
    ...
    /**
     * Metodo jTable2MouseClicked invocato al momento di un event click,
     * il quale aprirà i JPanel successivo relativo al brano selezionato
     * 
    ...
    /**
     * Metodo che riempe la tabella con i brani contenuti nella playlist passata
    ...
    /**
     * Metodo che trasforma i brani in un Vector per poterli inserire in una jTable
     *
