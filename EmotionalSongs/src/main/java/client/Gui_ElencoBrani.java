...
public class Gui_ElencoBrani extends javax.swing.JPanel {
     ...
     */
    public Gui_ElencoBrani(String userId, Playlist pl, EmotionalSongs emo) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "<html> <h3>Nome brano", "<html> <h3>Autore", "<html> <h3>Anno", "<html> <h3>Link"
            }
        ) {
    ...
    private void jTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable2MouseClicked
        ...
        // Salvo il link youtube per ascoltare la canzone
        ...
        String linkyt = source.getValueAt(row, 3).toString();

        // Rendo il pannello successivo visibile
        JDialog pnlEmozioni = new JDialog(this.previousframe, "PannelloEmozioni", true);
        pnlEmozioni.getContentPane().add(new PannelloEmozioni(idUtente, titolo, autore, previousframe));
        pnlEmozioni.pack();
        
        // Chiamo il metodo apriBrowser per aprire la canzone sul browser predefinito
        apriBrowser(linkyt);
    ...
    public void visualizzaBraniPlaylist() {
        ...
        ArrayList<Canzone> brani = new ArrayList<Canzone>();
        // Chiamo il metodo getBrani sulla playlist, per ottenere i brani
        brani = this.pl.getBrani();
     ...
     */
    private Vector<String> transform(int index, ArrayList<Canzone> brani) {
        ...
        if (index < brani.size()) {
            ...
            vector.add(brani.get(index).getAnno());
            vector.add(brani.get(index).getLinkyt());
    ...
    /**
     * Metodo per aprire il link della canzone sul browser predefinito del pc
     *
     * @param URIyt parametro di tipo String contenente l'URI della canzone
     */
    private void apriBrowser(String URIyt) {

        try {
            // Creo oggetto di tipo Desktop
            Desktop desktop = java.awt.Desktop.getDesktop();
            // Creo oggetto di tipo URI
            URI oURL = new URI(URIyt);
            // Apro il link
            desktop.browse(oURL);
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Errore #B0001.erroreAperturaBrowser", "Errore", JOptionPane.ERROR_MESSAGE);
            e.printStackTrace();
        }
