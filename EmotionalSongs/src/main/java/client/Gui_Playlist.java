...
public class Gui_Playlist extends javax.swing.JPanel {
     ...
     * @param is - riferimento al oggetto con i servizi del server
     */
     ...
     * nuova interfaccia passando l'idUtente, il nomePlaylist, il riferimeto al frame e l'oggetto InterfacciaServizio,
     ...
     * la nuova interfaccia passando l'idUtente , il riferimeto al frame e l'oggetto InterfacciaServizio,
     * rendendo visiblile la nuova interfacca e nascondendo questa
     *
     *@param evt - evento del click del bottone
     */
