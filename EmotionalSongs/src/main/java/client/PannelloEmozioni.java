 ...
 *
 * Classe rappresentante il pannello che visualizza la pagina per l'inserimento dei dati delle emozioni.
 *
 */
public class PannelloEmozioni extends javax.swing.JPanel {
     ...
     * @param titolo parametro di tipo String, contenente il titolo della canzone
     * @param autore parametro di tipo String, contenente l'autore della canzone
     * @param emo parametro di tipo EmotionalSongs contenente il riferimento al Frame iniziale
     * @param is parametro di tipo InterfacciaServizio contenente il riferimento all'oggetto con i servizi del server
     * @param idPlaylist parametro di tipo int contenente il l'identificatore della playlist
     */
     ...
     *
     * @param str parametro di tipo String contenente la variabile da controllare
     * 
     */
     ...
     *
     * @param idPlaylist parametro di tipo int contenente l'identificatore della playlist
     * @param titolo parametro di tipo String contenente il titolo della canzone
     * @param autore parametro di tipo String contenente l'autore della canzone
     * @param anno parametro di tipo int contenente l'anno della canzone
     * 
     */
    ...
    /**
     * Metodo per l'inserimento delle nuove emozioni inserite dall'utente nel database
     * mostrando un messaggio di successo o errore al compimento dell'azione
     *
     * @param emozioniCanzone parametro di tipo EmozioniCanzone contenente le nuove emozioni prelevate
     * @param canzone parametro di tipo Canzoni contenente la lista delle canzoni
     */
