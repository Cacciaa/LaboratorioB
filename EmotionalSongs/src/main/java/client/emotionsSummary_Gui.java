...
public class emotionsSummary_Gui extends javax.swing.JPanel {
     ...
     *
     * @param canzone variabile di tipo Canzone contenenete le canzoni selezionate dalla quale prelevare le emozioni
     * @param previousframe variabile di tipo EmotionalSongs contenente il riferimento al frame iniziale
     * @param is variabile di tipo InterfacciaServizio contenente il riferimento al oggetto con i servizi del server
     */
     ...
     *
     * @param emo_canzone oggetto di tipo Emozioni contenente la lista
    ...
    private Vector<String> transform(int index, ArrayList<EmozioniCanzone> brani) {
        ...
        if (index < brani.size()) {
            ...
            vector.add(Integer.toString(brani.get(index).getAmazement()));
            vector.add(Integer.toString(brani.get(index).getSolemnity()));
            vector.add(Integer.toString(brani.get(index).getTenderness()));
            vector.add(Integer.toString(brani.get(index).getNostalgia()));
            vector.add(Integer.toString(brani.get(index).getCalmness()));
            vector.add(Integer.toString(brani.get(index).getPower()));
            vector.add(Integer.toString(brani.get(index).getJoy()));
            vector.add(Integer.toString(brani.get(index).getTension()));
            vector.add(Integer.toString(brani.get(index).getSadness()));
            return vector;
        } else {
